...
import com.mycompany.backend.dao.BalanceGeneralDAO;
...
public class BalanceGeneral extends javax.swing.JFrame {
    ...
    private void cargarBalanceGeneral() {
        try {
            List<BalanceGeneralItem> balance = balanceGeneralDAO.getBalanceGeneral();
            DefaultTableModel model = (DefaultTableModel) jTableBalanceGeneral.getModel();
            model.setRowCount(0);
            for (BalanceGeneralItem item : balance) {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(jTableBalanceGeneral);
